...
<head>
  ...
  <title>Your Schoolnet Password</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #d6f1f5; height: 100%; margin: 0; padding: 0; width: 100%">
  <center>
 ...
 100%; background-color: #d6f1f5; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #61bbc9;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                  <img align="none" alt="" height="32" src="password.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 sans-serif; font-size: 25px; font-style: normal; font-weight: bold; line-height:
 125%; letter-spacing: 2px; text-align: center; display: block; margin: 0;
 padding: 0'><span style="text-transform:uppercase"><lable>Your Password for Your</lable></span></h1>
 ...
 padding: 0'><span style="text-transform:uppercase">Schoolnet Account</span></h2>
 ...
 100%; min-width:100%;" width="100%">
                          <tbody>
                            <tr>
                              <td class="mcnTextContent" style='mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
 color: #041c27; font-family: "Asap", Helvetica, sans-serif; font-size: 30px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px; ' valign="top"><lable style=" border-bottom:1px solid #06121a;">{{ $password }}</lable>
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-bottom: 24px; padding-left: 18px; color: #f7f7ff; font-family: 'Asap',
 ...
 font-weight: normal; text-decoration: none; color:#f7f7ff;" target="_blank" title="Noun Project - Icons for Everything">Noun Project</a>in Culver City, CA 90232</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
